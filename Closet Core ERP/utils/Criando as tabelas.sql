...
CREATE TABLE usuarios (
    ...
    status         VARCHAR2(15 BYTE) DEFAULT 'Ativo' NOT NULL,
    data_criacao   DATE DEFAULT SYSDATE NOT NULL,
    data_status    DATE,
    ultimo_login   DATE
);
...
-- Excluindo a tabela "estoque", concentrando as informações em "movimento_estoque":

DROP TABLE estoque CASCADE CONSTRAINTS;

-- Criando coluna "status" para a tabela pagamentos

ALTER TABLE pagamentos ADD status VARCHAR2(20 CHAR) DEFAULT 'Efetivado' NOT NULL;

-- Alterando o tamanho da coluna "status_conta"

ALTER TABLE contas_a_receber MODIFY status_conta VARCHAR(20 CHAR);

-- Adicionando a coluna "status" na tabela recebimentos

ALTER TABLE recebimentos ADD status VARCHAR(20 CHAR) DEFAULT 'Efetivado' NOT NULL;
